...
class LegalMentionsController extends Controller
{
    ...
    public function setup() : void
    {
        ...
        $this->setDescription("Des questions sur l'aspect légal de Devjobbers ? Retrouvez toutes les informations sur cette page.");
        ...
        $this->setView(__DIR__ . "/../Templates/pages/legal-mentions.php");
    }
