...
<header id="header" class="border-gray-200 px-2 sm:px-4 py-2.5 backdrop-blur-lg bg-white/80 dark:bg-slate-900/90 fixed w-full top-0 z-50 duration-500">
  <div class="container flex flex-wrap items-center justify-between mx-auto">
    <a href="<?= Main::getInstance()->getRootUrl() ?>" class="flex items-center">
    ...
    <div class="flex md:order-4">
      ...
      <button id="theme-button" title="Switch light" class="inline-flex items-center p-2 text-sm fill-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:fill-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
        <svg class="w-6 h-6 inline-flex items-center">
          <path id="theme-icon" fill-rule="evenodd" clip-rule="evenodd" d="M9.37 5.51A7.35 7.35 0 0 0 9.1 7.5c0 4.08 3.32 7.4 7.4 7.4.68 0 1.35-.09 1.99-.27A7.014 7.014 0 0 1 12 19c-3.86 0-7-3.14-7-7 0-2.93 1.81-5.45 4.37-6.49ZM12 3a9 9 0 1 0 9 9c0-.46-.04-.92-.1-1.36a5.389 5.389 0 0 1-4.4 2.26 5.403 5.403 0 0 1-3.14-9.8c-.44-.06-.9-.1-1.36-.1Z"></path>
        </svg>
      </button>
      <button type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center justify-center px-4 py-2 text-sm text-gray-500 rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
        <svg class="w-6 h-6 rounded-full" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 3900 3900">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      ...
      <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="<?= \AsaP\Main::getInstance()->getRootUrl() ?>" 
        ...
        <li>
          <a href="<?= \AsaP\Main::getInstance()->getRootUrl() . "/blog/" ?>" 
            class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
            Blog
          </a>
        </li>
        <li>
          <a href="<?= \AsaP\Main::getInstance()->getRootUrl() . "/services/" ?>" 
